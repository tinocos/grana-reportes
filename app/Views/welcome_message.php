...
function updateDiv(nombre_div) {
    $("#" + nombre_div).load(window.location.href + " #" + nombre_div);
     ...
     CKEDITOR.replace( 'institucion', {
      ...
      removeButtons: 'PasteText,PasteFromWord,Scayt,ExportPdf,Save,Styles,Language,Smiley,Link,Unlink,Form,Reference,Checkbox,Radio,TextField,Select,Textarea,Button,ImageButton,HiddenField,NewPage,CreateDiv,Flash,Iframe,About,ShowBlocks,Maximize',
...
//https://grana.enlineasistemas.com/css/style.css
//https://ckeditor.com/docs/ckeditor4/4.16.2/examples/assets/css/pastefromword.css
